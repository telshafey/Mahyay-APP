...
export const AZKAR_DATA: AzkarCategory[] = [
  ...
  },
  {
    ...
    items: [
        ...
        { id: 44, category: "أذكار ما بعد الصلاة", text: "أَعُوذُ بِاللهِ مِنْ الشَّيْطَانِ الرَّجِيمِ\n﴿اللَّهُ لاَ إِلَهَ إِلاَّ هُوَ الْحَيُّ الْقَيُّومُ...﴾ [آية الكرسي]", repeat: 1, reference: "من قرأها دبر كل صلاة لم يمنعه من دخول الجنة إلا أن يموت. [رواه النسائي وصححه الألباني]", notes: "آية الكرسي" },
        { id: 45, category: "أذكار ما بعد الصلاة", text: "سورة الإخلاص، سورة الفلق، سورة الناس", repeat: 1, reference: "تقرأ مرة واحدة بعد الظهر والعصر والعشاء، وثلاث مرات بعد الفجر والمغرب. [رواه أبو داود والترمذي]", notes: "المعوذات" }
    ]
  },
  {
    name: "أذكار عامة",
