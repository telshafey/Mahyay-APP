...
export const MOCK_FAQS: FAQ[] = [
    {
        ...
        a: 'يستخدم التطبيق موقعك الجغرافي (بعد الحصول على إذنك) لحساب مواقيت الصلاة بدقة عبر واجهة برمجة تطبيقات (API) موثوقة. يمكنك أيضًا اختيار طريقة الحساب المفضلة لديك من الإعدادات.'
    },
    {
        id: 'faq2',
        q: 'هل بياناتي آمنة؟ وأين يتم تخزينها؟',
        a: 'نعم، بياناتك آمنة. عند إنشاء حساب، يتم تخزين بياناتك بشكل آمن على خوادمنا ومزامنتها عبر أجهزتك. لديك السيطرة الكاملة على بياناتك ويمكنك حذفها في أي وقت.'
    },
    {
        id: 'faq3',
