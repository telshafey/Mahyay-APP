        ...
        <GlassCard className="text-white">
            ...
            <div className="prose prose-invert prose-headings:font-amiri prose-headings:text-yellow-300 prose-a:text-teal-300 max-w-none">
                ...
                <ul>
                    ...
                    <li><strong>بيانات الاستخدام:</strong> سجلات عباداتك (الصلوات، الأذكار، قراءة القرآن) وأهدافك الشخصية. يتم ربط هذه البيانات بحسابك وتخزينها بأمان.</li>
                </ul>

                <h4>3. تخزين البيانات</h4>
                <p>يتم تخزين جميع بياناتك بشكل آمن على جهازك (في الوضع التجريبي) أو على خوادم آمنة. نحن نستخدم أفضل الممارسات الأمنية لحماية معلوماتك.</p>
