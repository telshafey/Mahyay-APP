            ...
            faqs: [
                 {
                    ...
                    a: "عند تسجيل الدخول، يتم حفظ جميع بياناتك (صلواتك، أذكارك، تقدمك) بشكل آمن ومشفّر في حسابك الخاص على خوادمنا السحابية (Supabase). هذا يضمن أن بياناتك محفوظة دائمًا ويمكنك الوصول إليها من أي جهاز."
                },
                {
                    q: "هل يمكنني استخدام التطبيق على جهاز آخر ومزامنة بياناتي؟",
                    a: "نعم! هذه إحدى أهم الميزات الجديدة. طالما أنك تستخدم نفس حساب تسجيل الدخول، ستتم مزامنة جميع بياناتك تلقائيًا بين أجهزتك المختلفة، سواء كان هاتفًا أو جهازًا لوحيًا أو كمبيوتر."
                },
                {
                    q: "كيف يمكنني حذف جميع بياناتي؟",
                    a: "يمكنك الذهاب إلى 'الإعدادات' واختيار 'إعادة تعيين التطبيق بالكامل' من منطقة الخطر. هذا الإجراء سيحذف جميع بياناتك من حسابك نهائيًا ولا يمكن التراجع عنه."
                }
            ]
        },
        {
