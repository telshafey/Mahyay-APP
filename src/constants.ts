...
export const AZKAR_DATA: AzkarCategory[] = [
  ...
  },
  {
    ...
    items: [
        { id: 40, category: "أذكار ما بعد الصلاة", text: "أَسْتَغْفِرُ اللَّهَ (ثَلاثاً)، اللَّهُمَّ أَنْتَ السَّلامُ وَمِنْكَ السَّلامُ، تَبَارَكْتَ يَا ذَا الجَلالِ وَالإِكْرَامِ", repeat: 1, reference: "صحيح مسلم، رقم ٥٩١" },
        { id: 41, category: "أذكار ما بعد الصلاة", text: "لاَ إِلَهَ إِلاَّ اللَّهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ، اللَّهُمَّ لاَ مَانِعَ لِمَا أَعْطَيْتَ، وَلاَ مُعْطِيَ لِمَا مَنَعْتَ، وَلاَ يَنْفَعُ ذَا الْجَدِّ مِنْكَ الْجَدُّ", repeat: 1, reference: "صحيح البخاري، رقم ٨٤٤" },
        { id: 42, category: "أذكار ما بعد الصلاة", text: "لاَ إِلَهَ إِلاَّ اللَّهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ. لاَ حَوْلَ وَلاَ قُوَّةَ إِلاَّ بِاللَّهِ، لاَ إِلَهَ إِلاَّ اللَّهُ، وَلاَ نَعْبُدُ إِلاَّ إِيَّاهُ، لَهُ النِّعْمَةُ وَلَهُ الْفَضْلُ وَلَهُ الثَّنَاءُ الْحَسَنُ، لاَ إِلَهَ إِلاَّ اللَّهُ مُخْلِصِينَ لَهُ الدِّينَ وَلَوْ كَرِهَ الْكَافِرُونَ", repeat: 1, reference: "صحيح مسلم، رقم ٥٩٤" },
        { id: 43, category: "أذكار ما بعد الصلاة", text: "سُبْحَانَ اللَّهِ (٣٣ مرة)، وَالْحَمْدُ لِلَّهِ (٣٣ مرة)، وَاللَّهُ أَكْبَرُ (٣٣ مرة)، لاَ إِلَهَ إِلاَّ اللَّهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ", repeat: 1, reference: "من قالها دبر كل صلاة غفرت خطاياه وإن كانت مثل زبد البحر. [صحيح مسلم، رقم ٥٩٧]", notes: "التسبيح" },
        { id: 44, category: "أذكار ما بعد الصلاة", text: "أَعُوذُ بِاللهِ مِنْ الشَّيْطَانِ الرَّجِيمِ\n﴿اللَّهُ لاَ إِلَهَ إِلاَّ هُوَ الْحَيُّ الْقَيُّومُ لاَ تَأْخُذُهُ سِنَةٌ وَلاَ نَوْمٌ لَّهُ مَا فِي السَّمَاوَاتِ وَمَا فِي الأَرْضِ مَن ذَا الَّذِي يَشْفَعُ عِندَهُ إِلاَّ بِإِذْنِهِ يَعْلَمُ مَا بَيْنَ أَيْدِيهِمْ وَمَا خَلْفَهُمْ وَلاَ يُحِيطُونَ بِشَيْءٍ مِّنْ عِلْمِهِ إِلاَّ بِمَا شَاء وَسِعَ كُرْسِيُّهُ السَّمَاوَاتِ وَالأَرْضَ وَلاَ يَؤُودُهُ حِفْظُهُمَا وَهُوَ الْعَلِيُّ الْعَظِيمُ﴾", repeat: 1, reference: "من قرأها دبر كل صلاة لم يمنعه من دخول الجنة إلا أن يموت. [رواه النسائي وصححه الألباني]", notes: "آية الكرسي" },
        { id: 45, category: "أذكار ما بعد الصلاة", text: "بِسْمِ اللهِ الرَّحْمنِ الرَّحِيمِ\n﴿قُلْ هُوَ اللَّهُ أَحَدٌ ۞ اللَّهُ الصَّمَدُ ۞ لَمْ يَلِدْ وَلَمْ يُولَدْ ۞ وَلَمْ يَكُن لَّهُ كُفُوًا أَحَدٌ﴾\n\nبِسْمِ اللهِ الرَّحْمنِ الرَّحِيمِ\n﴿قُلْ أَعُوذُ بِرَبِّ الْفَلَقِ ۞ مِن شَرِّ مَا خَلَقَ ۞ وَمِن شَرِّ غَاسِقٍ إِذَا وَقَبَ ۞ وَمِن شَرِّ النَّفَّاثَاتِ فِي الْعُقَدِ ۞ وَمِن شَرِّ حَاسِدٍ إِذَا حَسَدَ﴾\n\nبِسْمِ اللهِ الرَّحْمنِ الرَّحِيمِ\n﴿قُلْ أَعُوذُ بِرَبِّ النَّاسِ ۞ مَلِكِ النَّاسِ ۞ إِلَهِ النَّاسِ ۞ مِن شَرِّ الْوَسْوَاسِ الْخَنَّاسِ ۞ الَّذِي يُوَسْوِسُ فِي صُدُورِ النَّاسِ ۞ مِنَ الْجِنَّةِ وَ النَّاسِ﴾", repeat: 1, reference: "تقرأ مرة واحدة بعد الظهر والعصر والعشاء، وثلاث مرات بعد الفجر والمغرب. [رواه أبو داود والترمذي]", notes: "المعوذات" }
    ]
  },
  {
    name: "أذكار عامة",
...
export const DAILY_WISDOMS = [
    { text: "اتق الله حيثما كنت، وأتبع السيئة الحسنة تمحها، وخالق الناس بخلق حسن.", source: "حديث شريف (الترمذي)" },
    { text: "عجباً لأمر المؤمن إن أمره كله خير، وليس ذاك لأحد إلا للمؤمن.", source: "حديث شريف (مسلم)" },
    { text: "من كان يؤمن بالله واليوم الآخر فليقل خيراً أو ليصمت.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "الدين النصيحة.", source: "حديث شريف (مسلم)" },
    { text: "احفظ الله يحفظك، احفظ الله تجده تجاهك.", source: "حديث شريف (الترمذي)" },
    { text: "لا تحقرن من المعروف شيئاً ولو أن تلقى أخاك بوجه طلق.", source: "حديث شريف (مسلم)" },
    { text: "من سلك طريقاً يلتمس فيه علماً سهل الله له به طريقاً إلى الجنة.", source: "حديث شريف (مسلم)" },
    { text: "إنما الأعمال بالنيات، وإنما لكل امرئ ما نوى.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "المسلم من سلم المسلمون من لسانه ويده.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "أحب الأعمال إلى الله أدومها وإن قل.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "ما نقص مال من صدقة.", source: "حديث شريف (مسلم)" },
    { text: "الكلمة الطيبة صدقة.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "إن الله جميل يحب الجمال.", source: "حديث شريف (مسلم)" },
    { text: "تهادوا تحابوا.", source: "الأدب المفرد (البخاري)" },
    { text: "من لا يرحم لا يرحم.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "الظلم ظلمات يوم القيامة.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "خيركم خيركم لأهله.", source: "حديث شريف (الترمذي)" },
    { text: "أقرب ما يكون العبد من ربه وهو ساجد، فأكثروا الدعاء.", source: "حديث شريف (مسلم)" },
    { text: "الدعاء هو العبادة.", source: "حديث شريف (الترمذي)" },
    { text: "ليس الشديد بالصرعة، إنما الشديد الذي يملك نفسه عند الغضب.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "لا يؤمن أحدكم حتى يحب لأخيه ما يحب لنفسه.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "من كان في حاجة أخيه كان الله في حاجته.", source: "حديث شريف (متفق عليه)" },
    { text: "الساعي على الأرملة والمسكين كالمجاهد في سبيل الله.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "إماطة الأذى عن الطريق صدقة.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "أتق المحارم تكن أعبد الناس.", source: "حديث شريف (الترمذي)" },
    { text: "ارض بما قسم الله لك تكن أغنى الناس.", source: "حديث شريف (الترمذي)" },
    { text: "من صمت نجا.", source: "حديث شريف (الترمذي)" },
    { text: "عليك بالصدق، فإن الصدق يهدي إلى البر.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "اياكم والظن، فإن الظن أكذب الحديث.", source: "حديث شريف (البخاري ومسلم)" },
    { text: "من تواضع لله رفعه.", source: "حديث شريف (مسلم)" }
];
